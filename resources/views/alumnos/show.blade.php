...
<div class="container">
    ...
    <select class="form-select" aria-label="Default select example" name="genero" id="genero"
        value="{{ $alumnos->genero }}" disabled="true">
    ...
    <input type="date" class="form-control" name="fecha_de_nacimiento" id="fecha_de_nacimiento"
        value="{{ $alumnos->fecha_de_nacimiento }}" disabled="true">

    <label for="curso_id">Curso</label>
    <input type="text" class="form-control" name="curso_id" id="curso_id" value="{{ $alumnos->curso->nombre }}"
        disabled="true">
    <br>
